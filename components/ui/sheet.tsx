...
/** Radix Sheet treats portaled popovers (Clerk, shadcn, etc.) as outside clicks. */
function isPortaledFloatingUiTarget(target: EventTarget | null) {
  return (
    target instanceof Element &&
    target.closest(
      '[data-radix-popper-content-wrapper], [class*="cl-"]'
    ) !== null
  )
}
...
function SheetContent({
  ...
  function guardPortaledFloatingUi(
    event: Parameters<
      NonNullable<
    ...
    if (isPortaledFloatingUiTarget(event.target)) {
